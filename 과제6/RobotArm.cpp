...
float tpTransZ = 0.0f;
float tpSpin = 0.0f;
float tpShoulderAng = 0.0f;
float tpElbowAng = 0.0f;
float tpWristAng = 0.0f;
float tpWristTwistAng = 0.0f;
float tpFingerAng1 = 0.0f;
float tpFingerAng2 = 0.0f;
...
const char* ourObjectPath = "./rabbit.obj"; // HW 5
...
void myDisplay()
{
	...
	objectXform = glm::rotate(objectXform, glm::radians(tpSpin), glm::vec3(0.0f, 1.0f, 0.0f));
	objectXform = glm::translate(objectXform, glm::vec3(tpTransX - BaseTransX, 0.0f, tpTransZ - BaseTransZ));
	...
	objectXform = glm::rotate(objectXform, glm::radians(tpShoulderAng), glm::vec3(0.0f, 0.0f, 1.0f));
	objectXform = glm::rotate(objectXform, glm::radians(ShoulderAng), glm::vec3(0.0f, 0.0f, -1.0f));
	objectXform = glm::translate(objectXform, glm::vec3(0.0f, -0.4f, 0.0f));
	...
	objectXform = glm::rotate(objectXform, glm::radians(tpElbowAng), glm::vec3(0.0f, 0.0f, 1.0f));
	objectXform = glm::rotate(objectXform, glm::radians(ElbowAng), glm::vec3(0.0f, 0.0f, -1.0f));
	objectXform = glm::rotate(objectXform, glm::radians(ShoulderAng), glm::vec3(0.0f, 0.0f, -1.0f));
	objectXform = glm::translate(objectXform, glm::vec3(0.0f, -0.4f, 0.0f));
	...
	objectXform = glm::translate(objectXform, glm::vec3(0.0f, 0.7f, 0.0f));
	objectXform = glm::rotate(objectXform, glm::radians(ShoulderAng), glm::vec3(0.0f, 0.0f, 1.0f));
	objectXform = glm::rotate(objectXform, glm::radians(ElbowAng), glm::vec3(0.0f, 0.0f, 1.0f));

	objectXform = glm::translate(objectXform, glm::vec3(0.0f, 0.55f, 0.0f));
	objectXform = glm::rotate(objectXform, glm::radians(WristAng), glm::vec3(0.0f, 0.0f, 1.0f));
	objectXform = glm::rotate(objectXform, glm::radians(tpWristTwistAng), glm::vec3(0.0f, 1.0f, 0.0f));
	objectXform = glm::rotate(objectXform, glm::radians(WristAng), glm::vec3(0.0f, 0.0f, -1.0f));
	objectXform = glm::translate(objectXform, glm::vec3(0.0f, -0.55f, 0.0f));
	...
	objectXform = glm::translate(objectXform, glm::vec3(0.0f, 110.0f, 0.0f));
	objectXform = glm::rotate(objectXform, glm::radians(-40.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	objectXform = glm::rotate(objectXform, glm::radians(-10.0f), glm::vec3(1.0f, 0.0f, 0.0f));
	objectXform = glm::rotate(objectXform, glm::radians(8.0f), glm::vec3(0.0f, 0.0f, 1.0f));
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// HW 6
		PhongShader->setBool("turnon", turnon);
		...
		// HW 6
		FloorShader->setBool("turnon", turnon);
...
void processInput(GLFWwindow* window, int key, int scancode, int action, int mods)
{
	...
	else if (key == GLFW_KEY_SPACE && action == GLFW_PRESS) // space bar
	{
		if (SpaceDown == 0) {
			SpaceDown = 1;
		}
	...
	if (LeftButtonDown)
	{
		switch (RobotControl)
		{
			...
			case 2: ShoulderAng += yoffset * -90; ElbowAng += xoffset * 90;
				if (SpaceDown)
				{
					tpShoulderAng += yoffset * -90;
					tpElbowAng += xoffset * 90;
				}
				break;
			...
			case 3: WristAng += yoffset * -180; WristTwistAng += xoffset * 180;
				if (SpaceDown)
				{
					tpWristAng += yoffset * -180;
					tpWristTwistAng += xoffset * 180;
				}
				break;
